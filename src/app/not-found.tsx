...
const NotFound = () => {
  return (
    <div className="h-screen flex gap-4 flex-col justify-center items-center text-white">
      ...
      <a href="/" className="text-lg space-y-4 bg-colors hover:brightness-75 text-white pl-10 pr-16 py-2 transition-[filter] duration-300 corner-br corner-black">Come back</a>
    </div>
  );
};
