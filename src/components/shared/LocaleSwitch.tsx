...
function DropdownMenuItem({locale}: { locale: Locale }) {
  ...
  return (
    <span onClick={() => onSelect(locale)} className="block px-4 py-2 text-sm hover:bg-grey-lightest dark:hover:bg-black active:bg-grey-light dark:active:bg-black">
      {locale.toUpperCase()}
    </span>
  );
}
    ...
    <div className="flex items-center gap-2 w-20">
      <div>
        <button
          ...
          id="menu-button" aria-expanded="true" aria-haspopup="true" onClick={onButtonClick}>
